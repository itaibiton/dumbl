...
export declare const INTERNAL_SESSION_TASK_ROUTE_BY_KEY: Record<SessionTask['key'], string>;
 ...
 * @internal
 */
export declare function navigateToTask(routeKey: keyof typeof INTERNAL_SESSION_TASK_ROUTE_BY_KEY, { componentNavigationContext, globalNavigate, options, environment }: NavigateToTaskOptions): Promise<unknown>;
export {};
