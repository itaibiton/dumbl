...
export declare const sanitizeInputProps: (obj: ReturnType<typeof useFormField>, keep?: (keyof ReturnType<typeof useFormField>)[]) => {
    name: FieldId;
    type?: "number" | "reset" | "submit" | "button" | "checkbox" | "radio" | "password" | "search" | "time" | "image" | "text" | "email" | "month" | "file" | "hidden" | "url" | "color" | (string & {}) | "date" | "datetime-local" | "range" | "tel" | "week" | undefined;
    options?: {
        value: string;
        label?: string;
    }[] | undefined;
